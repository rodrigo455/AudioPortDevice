...
void AudioPortDevice_base::construct()
{
    ...
    audio_sample_stream_ctrl_provides_port = new Packet_PayloadControl_In_i("audio_sample_stream_ctrl_provides_port", this);
    ...
    audio_sample_stream_provides_port = new Packet_UshortStream_In_i("audio_sample_stream_provides_port", this);
    ...
    audio_sample_msg_ctrl_provides_port = new DevMsgCtl_DeviceMessageControl_In_i("audio_sample_msg_ctrl_provides_port", this);
    ...
    audio_sample_stream_ctrl_uses_port = new Packet_PayloadControl_Out_i("audio_sample_stream_ctrl_uses_port", this);
    ...
    audio_sample_stream_uses_port = new Packet_UshortStream_Out_i("audio_sample_stream_uses_port", this);
